...
describe('Decentral Bank Deployment', async () => {
  ...
  describe('Yield Farming', async () => {
    it('rewards tokens for staking', async () => {
      ...
      assert.equal(result.toString(), tokens('100'), 'decentralBank mock wallet balance after staking from customer ')
      ...
      // Check Updated Balance of Decentral Bank
      result = await tether.balanceOf(decentralBank.address);
      assert.equal(result.toString(), tokens('0'), 'decentralBank mock wallet balance after staking from customer ')
